...
import { Dialog, Box, DialogActions, Button, Fade, IconButton } from '@material-ui/core';
...
var DialogRoot = styled(Abox)(function (_a) {
    var width = _a.width, isNullHeader = _a.isNullHeader, isNullFooter = _a.isNullFooter;
    return (__assign(__assign({ width: width || 360, padding: '16px 16px 12px 24px' }, (isNullHeader && {
        paddingTop: 0,
    })), (isNullFooter && {
        paddingBottom: 0,
    })));
...
var Content = function (_a) {
    ...
    return (React.createElement(Box, { m: '24px 0 28px 0' }, children));
};
...
var AuiDialog = function (inProps) {
    ...
    return (React.createElement(Dialog, __assign({ TransitionComponent: Fade }, otherProps),
        React.createElement(DialogRoot, __assign({}, rootProps),
